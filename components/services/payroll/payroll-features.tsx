...
const features = [
  {
    ...
    description: 'Calculating salaries, bonuses, deductions, and overtime with complete accuracy.',
    stat: 'Monthly'
  },
  {
    title: 'Statutory Compliance',
    description: 'Managing contributions and filings for EPF, ETF, PAYE, and other government-mandated requirements.',
    stat: 'Legal'
  },
  {
    title: 'Payslip Generation',
    description: 'Secure and timely issuance of digital or printed payslips.',
    stat: 'Secure'
  },
  {
    title: 'Tax Calculations',
    description: 'Ensuring proper tax deductions, filings, and year-end documentation.',
    stat: 'Tax'
  },
  {
    title: 'Leave & Attendance',
    description: 'Syncing payroll with attendance systems for accurate compensation.',
    stat: 'Sync'
  },
  {
    title: 'Benefits Administration',
    description: 'Managing expense claims, incentives, and other entitlements.',
    stat: 'Benefits'
  }
];

export function PayrollFeatures() {
  return (
