...
const features = [
  {
    ...
    description: 'From job profiling and candidate sourcing to final onboarding.',
    stat: 'Full Cycle'
  },
  {
    title: 'Executive Search',
    description: 'Targeted recruitment for senior-level and niche roles.',
    stat: 'Leadership'
  },
  {
    title: 'Volume Hiring',
    description: 'Scalable hiring solutions to meet large or time-sensitive workforce demands.',
    stat: 'Scale'
  },
  {
    title: 'Candidate Screening',
    description: 'Rigorous evaluation through interviews, assessments, and reference checks.',
    stat: 'Vetted'
  },
  {
    title: 'Employer Branding',
    description: 'Positioning your company as an employer of choice to attract top talent.',
    stat: 'Brand'
  }
];
